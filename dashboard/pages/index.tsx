...
export default function Dashboard() {
  const [oracleAddress, setOracleAddress] = React.useState('0x...');
  const [marketAddress, setMarketAddress] = React.useState('0x...');
  const [price, setPrice] = React.useState('$0.0000');

  return (
    <>
      <Head>
        <title>🦞 RSC/USDC Market - Morpho Blue on Base</title>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <header style={{
            ...
            <p style={{ fontSize: '18px', color: '#64c8ff' }}>
          ...
          <div style={{
            ...
            <div style={{ marginTop: '15px', fontFamily: "'Courier New', monospace", fontSize: '12px', color: '#64c8ff' }}>
              <strong>Oracle Address:</strong><br />
